...
export function AudioPlayer() {
	...
	return (
		<div className='flex items-center gap-6 bg-zinc-800 py-4 px-4 shadow shadow-slate-200/80 ring-1 ring-slate-900/5 backdrop-blur-sm md:px-6'>
			...
			<div className='mb-[env(safe-area-inset-bottom)] flex flex-1 flex-col gap-3 overflow-hidden p-1'>
				<Link
					...
					className='truncate text-center text-sm font-bold leading-6 md:text-left text-gray-200'
				...
				<div className='flex justify-between gap-6'>
					...
					<Slider
						...
						step={1}
						value={[(currentTime as string) ?? player.currentTime].toString()}
